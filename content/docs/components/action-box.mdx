...
<Tabs items={["pnpm", "npm", "yarn"]}>
  <Tab value="pnpm">pnpm dlx solanaui@latest add action-box</Tab>
  <Tab value="npm">npx solanaui@latest add action-box</Tab>
  <Tab value="yarn">yarn solanaui@latest add action-box</Tab>
</Tabs>
