...
<Tabs items={["pnpm", "npm", "yarn"]}>
  <Tab value="pnpm">pnpm dlx shadcn@latest add @solanaui/auth-card</Tab>
  <Tab value="npm">npx shadcn@latest add @solanaui/auth-card</Tab>
  <Tab value="yarn">yarn dlx shadcn@latest add @solanaui/auth-card</Tab>
</Tabs>
