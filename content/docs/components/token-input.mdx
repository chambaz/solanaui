---
title: Token Input
description: An input field for entering token amounts with a token selector, balance display, and automatic number formatting
---
...
<Tabs items={["pnpm", "npm", "yarn"]}>
  <Tab value="pnpm">pnpm dlx shadcn@latest add @solanaui/token-input</Tab>
  <Tab value="npm">npx shadcn@latest add @solanaui/token-input</Tab>
  <Tab value="yarn">yarn dlx shadcn@latest add @solanaui/token-input</Tab>
</Tabs>
